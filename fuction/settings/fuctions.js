...
const banner2 = cfonts.render((`Proyecto: AkameBot-MD\nCreador: Gabriel-V`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`AKAME|BOT`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "Gabriel-V"
const packname = "Creador: Gabriel-V"
...
module.exports = { getBuffer, fetchJson, fetchText, generateMessageID, getGroupAdmins, getMembros, getRandom, banner2, temporizador, color, recognize, bgcolor, isFiltered, addFilter, banner3, getExtension, convertSticker, upload, getpc }
